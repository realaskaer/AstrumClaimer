...
NEEDED_WALLETS_CHECKER = 0     # 0 / 3 / [3, 20] / [[3, 20]]. Аналогично работе WALLETS_TO_WORK
...
GAS_PRICE_MULTIPLIER = 0.9      # Множитель цены газа для транзакций. Ускоряет выполнение или уменьшает цену транзакции
...
# ASTRUM SOLVER API KEY https://t.me/astrumsolutionsbot
ASTRUMSOLVER_API_KEY = ''
