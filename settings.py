...
HYPERLANE_CEX_USE = 1  # Какую биржу использовать под додеп (1 - OKX, 3 - Binance)
HYPERLANE_USENEXUS_ADDRESS = True  # если True, то необходимо указать адреса куда будет произведен бридж (в таблицу Transfer address)
